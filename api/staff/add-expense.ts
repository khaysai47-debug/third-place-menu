...
// production surface for POST /api/staff/add-expense. Delegates to the
...
import { methodNotAllowed, postAddExpense } from "../_lib/staffOrderWrites.server.js";

export const POST = postAddExpense;
