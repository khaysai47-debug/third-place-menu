...
// production surface for POST /api/menu-session/resolve (Phase 3D secure-link
// state lookup; PUBLIC, the token in the JSON body is the credential).
...
import { postResolveSession } from "../_lib/botSession.server.js";
import { methodNotAllowed } from "../_lib/staffOrderWrites.server.js";

export const POST = postResolveSession;
